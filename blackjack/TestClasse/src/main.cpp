...
static constexpr std::string_view AGENT_NAME = "TestClasse";
...
void print_usage(void){
    ...
    std::cout << "    ./TestClasse --verbose --device en0 --port 5670" << std::endl << std::endl;
...
//                exit(IGS_FAILURE);
    ...
    //initialize agent
    TestClasse *agent = new TestClasse();
