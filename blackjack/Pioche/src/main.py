...
def on_agent_event_callback(event, uuid, name, event_data, my_data):
    try:
        ...
        assert isinstance(agent_object, Pioche)
...
# attributes
def Cartes_attribute_callback(io_type, name, value_type, value, my_data):
    try:
        agent_object = my_data
        assert isinstance(agent_object, Pioche)
        agent_object.CartesA = value
        # add code here if needed
    except:
        print(traceback.format_exc())
...
# services
def Tirercarte_callback(sender_agent_name, sender_agent_uuid, service_name, tuple_args, token, my_data):
    try:
        agent_object = my_data
        assert isinstance(agent_object, Pioche)
        agent_object.Tirercarte(sender_agent_name, sender_agent_uuid)
    except:
        print(traceback.format_exc())
...
if __name__ == "__main__":
    ...
    igs.observe_attribute("cartes", Cartes_attribute_callback, agent)

    igs.service_init("tirerCarte", Tirercarte_callback, agent)
